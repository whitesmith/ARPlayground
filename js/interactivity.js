function displayValue(element, val) {
...
tam=size;
    displayValue('.js-display-value', size);
}


const sizeHandler = document.querySelector('.js-size-handler');

sizeHandler.addEventListener('change', handleSizeUpdate);
sizeHandler.addEventListener('mousemove', handleSizeUpdate);
sizeHandler.addEventListener('touchmove', handleSizeUpdate);
